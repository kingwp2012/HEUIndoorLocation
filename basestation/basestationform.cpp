    ...
    ui(new Ui::BaseStationForm)
{
    ...
    idEdit->setPlaceholderText(QString::fromLocal8Bit("请输入基站ID"));
    macEdit->setPlaceholderText(QString::fromLocal8Bit("请输入基站物理地址"));
    cateEdit->setPlaceholderText(QString::fromLocal8Bit("请输入建站类型"));
    xEdit->setPlaceholderText(QString::fromLocal8Bit("基站x轴坐标"));
    yEdit->setPlaceholderText(QString::fromLocal8Bit("基站y轴坐标"));
    zEdit->setPlaceholderText(QString::fromLocal8Bit("基站z轴坐标"));
    remarkEdit->setPlaceholderText(QString::fromLocal8Bit("备注"));

    formlayout->addRow(QString::fromLocal8Bit("&基站ID："),idEdit);
    formlayout->addRow(QString::fromLocal8Bit("&基站MAC: "),macEdit);
    formlayout->addRow(QString::fromLocal8Bit("&基站类型："),cateEdit);
    formlayout->addRow(QString::fromLocal8Bit("&基站X坐标："),xEdit);
    formlayout->addRow(QString::fromLocal8Bit("&基站Y坐标："),yEdit);
    formlayout->addRow(QString::fromLocal8Bit("&基站Z坐标："),zEdit);
