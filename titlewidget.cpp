    ...
    : QWidget(parent)
{
   ...
   // skin_button = new PushButton();
    ...
    warning_button->loadPixmap(":/new/images/message1.png");
...
*/
  //  connect(skin_button, SIGNAL(clicked()), this, SIGNAL(showSkin()));
   ...
   // title_layout->addWidget(skin_button, 0, Qt::AlignTop);
    ...
    string_list<<":/new/images/jizhan.png"<<":/new/images/camera.png"<<":/new/images/biaoqian.png"<<":/new/images/kaoqin.png"
              <<":/new/images/maps.png"<<":/new/images/person.png"<<":/new/images/way.png"<<":/new/images/personal-center.png"
...
//{
    ...
    button_list.at(0)->setText(QStringLiteral("基站管理"));
    //button_list.at(0)->setIconSize(QSize(40,40));
    button_list.at(1)->setText(QStringLiteral("摄像头联动"));
   // button_list.at(1)->setIconSize(QSize(40,40));
    button_list.at(2)->setText(QStringLiteral("标签管理"));
   // button_list.at(2)->setIconSize(QSize(40,40));
    button_list.at(3)->setText(QStringLiteral("考勤管理"));
   // button_list.at(3)->setIconSize(QSize(40,40));
    button_list.at(4)->setText(QStringLiteral("地图管理"));
   // button_list.at(4)->setIconSize(QSize(40,40));
    button_list.at(5)->setText(QStringLiteral("人员管理"));
   // button_list.at(5)->setIconSize(QSize(40,40));
    button_list.at(6)->setText(QStringLiteral("路径管理"));
   // button_list.at(6)->setIconSize(QSize(40,40));
    button_list.at(7)->setText(QStringLiteral("电子围栏"));
  //  button_list.at(7)->setIconSize(QSize(40,40));
    button_list.at(8)->setText(QStringLiteral("巡逻管理"));
  //  button_list.at(8)->setIconSize(QSize(40,40));


   connect( button_list.at(0), SIGNAL(clicked()), this, SIGNAL(showJzwidget()));
   connect( button_list.at(1), SIGNAL(clicked()), this, SIGNAL(showBqwidget()));
   connect( button_list.at(2), SIGNAL(clicked()), this, SIGNAL(showTrueBqwidget()));
   connect( button_list.at(3), SIGNAL(clicked()), this, SIGNAL(showKqwidget()));
